"""
Django settings for bentomap project.
...
SECRET_KEY = 'ectfwk+d)tvsjvg-k=_+qoq#picz3d3+g0$fr7(pfguuf9kg%1'
...
WSGI_APPLICATION = 'bentomap.wsgi.application'
